...
main.py
--------
Đây CHƯA PHẢI là app PyQt6 thật. Đây là file kiểm tra: chạy thử để chắc chắn
folder + 3 module đầu tiên (config, patient, hr_target) hoạt động đúng
với nhau, trước khi bắt đầu xây UI.
